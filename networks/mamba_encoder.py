...
class VSSM(nn.Module):
    ...
    @staticmethod
    def _make_patch_embed_v3(in_chans=3, embed_dim=96, patch_size=4, patch_norm=True, norm_layer=nn.LayerNorm,
                             channel_first=False):
        # if channel first, then Norm and Output are both channel_first
        stride = patch_size // 2
        kernel_size = stride + 1
...
def MonoViM(**kwargs):
    model = MambaEncoder(
        ...
        patchembed_version="v2",  # "v1", "v2", "v3"
        use_checkpoint=False,
        # =========================
        posembed=False,
        imgsize=224,
...
def MonoViM_LST(**kwargs):
    model = MambaEncoder(
        ...
        norm_layer="LN2D",  # "BN", "LN2D"
        downsample_version="v3",  # "v1", "v2", "v3"
        patchembed_version="v3",  # "v1", "v2", "v3"
        use_checkpoint=False,
        # =========================
        posembed=False,
        imgsize=224,
